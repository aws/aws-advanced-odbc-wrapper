...
public:
    LimitlessRouterService(const std::shared_ptr<DialectLimitless> &dialect, const std::map<std::string, std::string> &conn_attr, const std::shared_ptr<OdbcHelper> &odbc_helper);
