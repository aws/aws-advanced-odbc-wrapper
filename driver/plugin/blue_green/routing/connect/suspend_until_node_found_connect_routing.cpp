    ...
    std::shared_ptr<ConcurrentMap<std::string, BlueGreenStatus>> status_cache)
{
    ...
    const std::chrono::milliseconds timeout = MapUtils::GetMillisecondsValue(dbc->conn_attr, KEY_BG_CONNECT_TIMEOUT_MS, DEFAULT_CONNECT_TIMEOUT_MS);
