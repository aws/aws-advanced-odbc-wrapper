...
public:
    ClusterTopologyQueryHelper(std::shared_ptr<RdsLibLoader> lib_loader, int port, std::string endpoint_template, std::string topology_query, std::string writer_id_query, std::string node_id_query);
