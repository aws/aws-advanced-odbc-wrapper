...
SQLRETURN AuroraInitialConnectionStrategyPlugin::GetVerifiedWriter(DBC* dbc) {
...
SQLRETURN AuroraInitialConnectionStrategyPlugin::GetVerifiedReader(DBC* dbc) {
    const std::chrono::time_point<std::chrono::steady_clock> end_time = std::chrono::steady_clock::now() + this->retry_timeout_ms_;
