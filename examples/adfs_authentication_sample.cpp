...
int main() {
    ...
    SQLCHAR* conn_str = reinterpret_cast<SQLCHAR*>(
        ...
        // ADFS Configuration
        "RDS_AUTH_TYPE=ADFS;"
        "IDP_ENDPOINT=my-adfs-host.com;"
        "IDP_PORT=443;"
        "IDP_USERNAME=user@email.com;"
        "IDP_PASSWORD=my_idp_password;"
        "IDP_ROLE_ARN=arn:aws:iam::123412341234:role/ADFS-SAML-Assume;"
        "IDP_SAML_ARN=arn:aws:iam::123412341234:saml-provider/ADFS-AWS-IAM;"
        // Optional Flags
