...
function Invoke-SignInstaller {
    ...
    $unsignedInstallerPath=$(Join-Path $BuildDir "aws-advanced-odbc-wrapper.msi")
    $signedInstallerPath=$(Join-Path $BuildDir "aws-advanced-odbc-wrapper-$OdbcVersion-$Architecture-signed.msi")
    ...
    Rename-Item -Path $signedInstallerPath -NewName "aws-advanced-odbc-wrapper-$OdbcVersion-$Architecture.msi"
