...
| Wait for Custom Endpoint Info Timeout | `WAIT_FOR_CUSTOM_ENDPOINT_TIMEOUT_MS`     | The maximum amount of time the custom endpoint plugin will wait for custom endpoint information from the monitor.                                                                                                                                                         | `5000`        | `1000`        |
