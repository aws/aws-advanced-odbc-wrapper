...
| `BASE_CONN` / `nil` | `String` | No | For additional settings to the underlying driver, the connection string can be used for the specific underlying driver's options too. | `nil` |
