...
This is only required if you are not using the installer script.
...
You can also build the installer via the following:

```
./installer/build_installer.ps1 <Release/Debug>
```
